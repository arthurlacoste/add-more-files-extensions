...
function display_ext_section() {
	...
	<table class="form-table">
		<?php do_settings_fields('media', 'uploads_ext'); ?>
	</table>
	<?php
}
...
function add_media_field() {
	if (is_multisite()) {
		add_settings_section( 'ext', __('Uploading Files'), 'display_ext_section', 'media' );
		add_settings_field( 'ext', __('Extensions'), 'display_ext', 'media', 'uploads_ext', array( 'label_for' => 'ext' ) );
	} else {
